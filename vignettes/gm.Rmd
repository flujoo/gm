...
you need to specify the path to the MuseScore executable:

1. Open ".Renviron" file. You can do this with `usethis::edit_r_environ()`.

2. Add `MUSESCORE_PATH=<path to MuseScore executable>` into it.
For example, suppose on a computer using Windows the path is
"C:/Program Files/MuseScore 3/bin/MuseScore3.exe", you can add
`MUSESCORE_PATH=C:/Program Files/MuseScore 3/bin/MuseScore3.exe`, if gm
can't figure it out.
