...
2. Add `MUSESCORE_PATH=<path to MuseScore>`.
3. Restart R session.

For example, in Windows, you can add something like `MUSESCORE_PATH=C:/Program Files/MuseScore 4/bin/MuseScore4.exe` to .Renviron file.
