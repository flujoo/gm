...
A `Music` object is represented as a list of data frames. Each data frame represents a type of components added to it. To examine a `Music` object's representation, simply print it. For example, the representation of the `Music` object created in the *Quick Example* section:
